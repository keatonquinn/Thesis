...
\begin{center} {\sf DRAFT VERSION 4 --- {\today} } \end{center}
...
Since Epstein surfaces are strictly convex, the second fundamental form $\two_\epsilon$ is negative definite (negative due to our choice of normal vector field), and so $-\two_\epsilon$ is a Riemannian metric, giving another point $[\two_\epsilon]$ in $\mathcal{T}(S)$.
...
\]
where $\overset{\circ}{\nabla}\rho$ is the spherical gradient of $\rho$. 
